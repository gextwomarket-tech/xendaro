...
<title>Brocker — Vérification email</title>
...
<div class="container">
  <div class="card fade-in">
    ...
    <h1 style="font-size:24px;font-weight:800;color:#2C3947;margin-bottom:6px;">Vérifiez votre email</h1>
    <p style="font-size:14px;color:#74777c;margin-bottom:28px;line-height:1.7;">Nous avons envoyé un lien de vérification à votre email. Cliquez sur le lien pour activer votre compte.</p>
    ...
    <form method="POST" action="{{ route('auth.resend-verification.post') }}">
      @csrf
      <div style="margin-bottom:20px;">
        <label style="display:block;font-size:13px;font-weight:600;color:#2C3947;margin-bottom:6px;">Votre email</label>
        <input 
          type="email" 
          name="email"
          class="input-field"
    ...
    <div style="text-align:center;margin-top:20px;font-size:13px;color:#74777c;">
