<div x-data="{
    ...
    x-init="tick()"
>
    <h1 class="font-display text-2xl font-bold text-texte-principal">{{ __('app.auth.verify_email_title') }}</h1>
    <p class="mt-1 text-sm text-texte-secondaire">{{ __('app.auth.verify_email_text', ['email' => auth()->user()->email]) }}</p>
